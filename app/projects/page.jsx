...
const projects = [
  {
    ...
    image: "/assets/stock-prediction.jpg",
    live: "",
    github: "",
    githubOther: "TBD",
  },
  {
    ...
    category: "cloud",
    teamSize: "1",
    title: "VPC with servers in private subnets and NAT",
    description:
      "The purposed of this project was to gain exposure within AWS. The VPC has public subnets and private subnets in two Availability Zones. Each public subnet contains a NAT gateway and a load balancer node. The servers run in the private subnets, are launched and terminated by using an Auto Scaling group, and receive traffic from the load balancer. The servers were simple web applications to demonstrate how the load balancer would distribute traffic across multiple servers.",
    stack: [
      {
        name: "AWS VPC",
      },
    ...
    image: "/assets/vpc-example-private-subnets.jpg",
    live: "",
    github: "",
    githubOther: "TBD",
  },
