...
function TabsTrigger({ className, ...props }) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex items-center w-full bg-[#27272c] justify-center whitespace-nowrap text-white rounded-lg p-3 text-base font-medium ring-offset-white transition-all disable:pointer-events-none disables:opacity-50 data-[state=active]:bg-accent data-[state=active]:text-primary data-[data=active]:font-bold data-[state=active]:shadow-sm",
        className
      )}
      {...props}
    />
